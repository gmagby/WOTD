...
def first_definition():
    for t in range (len(formated_definition)):
        ...
        st.write('A minority group the resides primarily in Pakistan and Iran. If the the war in Iran continues you will likely hear about the Baloch if malevolent forces attempt to use them to undermine the Iranian government.')
